        ...
        startups_data = [
            {
                ...
                "content.data.website": getattr(s.content.data, "website", "") or "",
                "content.data.batch": getattr(s.content.data, "batch", "") or "",
                "content.data.location": getattr(s.content.data, "location", "") or "",
                "content.data.status": getattr(s.content.data, "status", "Active") or "Active",
        ...
        papers_data = [
            {
                ...
                "content.rank": getattr(r.content, "rank", None) or 0,
                ...
                "content.pdf_url": getattr(r.content, "pdf_url", "") or "",
                "content.github_url": r.content.github_url or "",
                "content.github_stars": r.content.github_stars or 0,
                "content.huggingface_url": getattr(r.content, "huggingface_url", "") or "",
                "content.huggingface_upvotes": getattr(r.content, "huggingface_upvotes", 0) or 0,
                "content.source_platform": getattr(r.content, "source_platform", "ArXiv") or "ArXiv",
                "content.has_code": getattr(r.content, "has_code", False) or False,
                "content.impact_score": getattr(r.content, "impact_score", 0.0) or 0.0,
